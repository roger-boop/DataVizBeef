...
A posible explanation for such fidelityt could be that the data used to create UMAP_Y is also the one we are giving to the prediction, therefore we might be having overfitting.
